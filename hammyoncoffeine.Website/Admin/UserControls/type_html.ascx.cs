...
namespace hammyoncoffeine.Website
{
    ...
    public partial class Admin_type_html : System.Web.UI.UserControl
    {
        public string page = "";
        ...
        protected void save_OnClick(object sender, EventArgs e)
        {
            ...
            if (DataIO.saveItemContent(new XElement("content", txtContent.Text),r_folder, r_page, r_item, "html", shared_item))
            {
